				...
				<div class="products-listing">
					...
					foreach ( $productList as $product ) {
						...
						<?php } ?>
							...
							<div class="item item_product product <?php if (abs($product->prices['discountAmount']) > 0 && ($product->prices['salesPrice'] < $product->prices['salesPriceWithDiscount'] ) ){ echo 'sale';} ?>" style="<?php echo $cellwidth; ?>">
								<div class="product_wrap">
									...
									<div class="item_image product_image">
										...
										<div class="fright-btn">
										 <div class="item_name product_addtocart">
											...
											<a class="addtocart-button btn btn-primary" href="<?php echo $url ?>"><?php echo JText::_('TM_DETAILS'); ?></a> 
										</div>
										</div>
									</div>
