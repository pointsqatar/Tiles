...
<?php endforeach;?>
		...
		<div>
			<button type="submit" class="btn btn-primary validate button"><?php echo JText::_('JSUBMIT'); ?></button>
			<?php echo JText::_('COM_USERS_OR'); ?>
			<a class="btn btn-default button" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><span><span><?php echo JText::_('JCANCEL'); ?></span></span></a>
