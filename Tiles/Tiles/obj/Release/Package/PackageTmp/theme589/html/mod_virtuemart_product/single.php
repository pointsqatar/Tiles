...
<div id="slider<?php echo $params->get ('class_sfx'); ?>" class="vm-products vm-products-slider <?php echo $params->get ('moduleclass_sfx') ? 'vm-products__' . $params->get ('moduleclass_sfx') : '' ?>">
                          		 ...
                          		 <div class="relative">    
									<div class="product_addtocart vm3pr">
									 ...
									 <div class="item_name product_desc">
										...
										<a href="<?php echo $url ?>"><i class="fa fa-cog"></i><?php echo JText::_('TM_DETAILS'); ?></a> 
									</div>
...
jQuery(document).ready(function() {
	jQuery(".vm-products-slider .<?php echo 'owl-demo-'.$params->get ('moduleclass_sfx'); ?>").owlCarousel({
	autoPlay : 122000,
	stopOnHover : true,
	navigation:true,
	pagination:false,
