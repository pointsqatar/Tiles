	...
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
		...
		<?php endif; ?>
			<div class="logout-button">
                <button type="submit" name="Submit" class="btn btn-default button"><?php echo JText::_('JLOGOUT'); ?></button>
...
<?php else : ?>
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
        ...
        <button type="submit" name="Submit" class="btn btn-default button"><?php echo JText::_('JLOGIN') ?></button>
