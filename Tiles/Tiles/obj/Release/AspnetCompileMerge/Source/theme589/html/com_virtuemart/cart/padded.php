...
<div class="cart-popup">
	...
	<?php 
	echo '<a class="btn btn-default continue button" href="' . $this->continue_link . '" ><span><span>' . JText::_('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</span></span></a>';
	echo '<a class="btn btn-primary showcart button pull-right" href="' . $this->cart_link . '"><span><span>' . JText::_('COM_VIRTUEMART_CART_SHOW') . '</span></span></a>';
	if($this->products){
