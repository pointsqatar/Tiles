					...
					<script type="text/javascript">
                        ...
                        <?php // Display the quantity box 
                                        ...
                                        <?php
											...
											<a data-toggle="tooltips" data-placement="top" title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_ADD_TO') ?>"  name="addtocart" href="#" class="addtocart-button add btn btn-primary"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_CART_ADD_TO') ?></span></span></a>
                                            
										<?php } else { ?>
                                       		 <a data-toggle="tooltip" data-placement="top" title="<?php echo vmText::_ ('COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT') ?>"  name="addtocart" href="#" class="addtocart-button btn btn-primary addtocart-button-disabled"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT') ?></span></span></a>
										<?php } ?>
                                        </div>
