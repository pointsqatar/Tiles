...
if ($this->allowRating || $this->showReview) {
	...
	if ($this->showReview) { ?>
	<h4 class="product-section_title"><?php echo JText::_ ('COM_VIRTUEMART_REVIEWS') ?></h4>
	...
	if ($this->allowReview) { ?>
		<div class="product-reviews_form">
...
//]]>
			...
			if ($review_editable) { ?>
				...
				<button class="btn btn-primary pull-right button" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>" value=""><?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?></button>
