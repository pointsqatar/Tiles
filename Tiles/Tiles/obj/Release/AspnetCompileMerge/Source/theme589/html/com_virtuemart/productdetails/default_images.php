...
if (!empty($this->product->images)) {
	...
	<div class="product_image__main item_image main-image">
		<a href="<?php echo $image->file_url; ?>" class="swipebox product_image_zoom" data-rel="vm-additional-images__mobile"><i class="fa fa-search-plus"></i></a>
		
		<?php 
		for ($img = 1; $img < $count_images; $img++) { ?>
			<a href="<?php echo $this->product->images[$img]->file_url; ?>"  class="product-image swipebox image-<?php echo $img; ?>" title="<?php echo $this->product->images[$img]->file_meta; ?>" data-rel="vm-additional-images__mobile"></a>				
		<?php }	?>		

		<?php echo $image->displayMediaFull("width='100%' ", true," alt='' id='product_image' class='jqzoom' data-rel='vm-additional-images'"); ?>
	</div>	
