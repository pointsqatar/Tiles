    ...
    <div class="order-view">
        ...
        <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" class="form-inline">
        	...
        	<div class="form-group" id="com-form-order-pass">
                ...
                <button type="submit" name="Submitbuton" class="btn btn-default"><span><span><?php echo JText::_('COM_VIRTUEMART_ORDER_BUTTON_VIEW') ?></span></span></button>
...
<?php } ?>
    ...
    <form id="com-form-login" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login">
	    ...
	    <?php if (!$this->from_cart ) { ?>
        	<div>
        		<h2 class="login"><?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h2>
        	</div>
        <?php } else { ?>
    ...
    <div class="container2">
        ...
        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
        	 <div class="row">
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <button type="submit" name="Submit" class="btn btn-default"><span><span><?php echo JText::_('COM_VIRTUEMART_LOGIN') ?></span></span></button>
                 </div>
...
<?php  } else if ( $user->id ) { ?>
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login">
        <span class="username"><?php echo JText::sprintf( 'COM_VIRTUEMART_HINAME', $user->name ); ?></span>
		<button type="submit" name="Submit" class="btn btn-default"><span><span><?php echo JText::_( 'COM_VIRTUEMART_BUTTON_LOGOUT'); ?></span></span></button>
        <input type="hidden" name="option" value="<?php echo $comUserOption ?>" />
