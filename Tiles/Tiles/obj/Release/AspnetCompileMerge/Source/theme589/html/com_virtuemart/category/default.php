...
<div class="vm-category_product-listing products-listing vertical">
	...
	foreach ($this->products as $product) {
		...
		if ($iBrowseCol == 1) {
			...
			// Show Products
			?>
			<div class="product item item_product <?php if (abs($product->prices['discountAmount']) > 0 && ($product->prices['salesPrice'] < $product->prices['salesPriceWithDiscount'] ) ){ echo 'sale';} ?>">
				<div class="product_wrap">
						...
						<div class="indent">
							...
							<h4 class="item_name product_title">
								<?php echo JHTML::link ($product->link, shopFunctionsF::limitStringByWord ($product->product_name,30, '...')); ?>
							</h4>
