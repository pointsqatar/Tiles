...
<div class="mod-vm-search <?php echo $params->get('moduleclass_sfx'); ?>">
	<form action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=category&search=true&limitstart=0&virtuemart_category_id='.$category_id ); ?>" method="get" class="form-inline">
		<div class="search-form">
			<?php 
				$output = '<div class="form-group"><input name="keyword" id="mod_virtuemart_search" maxlength="160" alt="'.$button_text.'" class="inputbox form-control '.$moduleclass_sfx.'" type="text" size="'.$width.'" value="'.$text.'"  onblur="if(this.value==\'\') this.value=\''.$text.'\';" onfocus="if(this.value==\''.$text.'\') this.value=\'\';" /></div>';
