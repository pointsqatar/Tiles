...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $tpath;?>/css/vm/virtuemart.css" type="text/css" />
...
<jdoc:include type="message" />
	...
	<fieldset class="input">
		...
		<?php endif; ?>
		<p id="submit-buton">
           <button type="submit" name="Submit" class="btn btn-default button login"><span><span><?php echo JText::_('JLOGIN') ?></span></button>
