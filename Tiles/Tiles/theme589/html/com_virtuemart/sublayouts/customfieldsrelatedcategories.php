...
if (!empty($product->customfieldsSorted[$position])) {
	...
	<h4 class="product-section_title"><?php echo JText::_('COM_VIRTUEMART_RELATED_CATEGORIES'); ?></h4>
	<div class="products-listing">
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			continue;
			?><div class="item item__product product-field product-field-type-<?php echo $field->field_type ?>">
