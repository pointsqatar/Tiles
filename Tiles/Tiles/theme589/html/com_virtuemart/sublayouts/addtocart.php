        ...
        <input name="quantity" type="hidden" value="<?php echo $step ?>" />
			...
			if (!VmConfig::get('use_as_catalog', 0)  ) { ?>
                ...
                <div class="form-group">
					<a data-toggle="tooltips" data-placement="top" title="<?php echo JText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?>"  href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id); ?>" class="addtocart-button btn btn-primary"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?></span></span></a>
				</div>	
					<?php
				} else {
				...
				if (!empty($product->customfieldsSorted[$position])) { 
					//echo '1'; ?>
					 <div class="form-group">
						<a data-toggle="tooltips" data-placement="top" title="<?php echo vmText::_ ('TM_VIRTUEMART_CART_SELECT') ?>"  href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id); ?>" class="addtocart-button btn btn-primary select"><span><span><?php echo vmText::_ ('TM_VIRTUEMART_CART_SELECT') ?></span></span></a>
					</div>		
				<?php }else {
					//echo '0';
					...
					if (!( VmConfig::get('askprice', true) and empty($tmpPrice) ) ) { ?>
						...
						<div class="form-group">
							 <?php
								...
								<a data-toggle="tooltips" data-placement="top" title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_ADD_TO') ?>"  name="addtocart" href="#" class="addtocart-button btn btn-primary add"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_CART_ADD_TO') ?></span></span></a>
								
							<?php } else { ?>
								 <a data-toggle="tooltips" data-placement="top" title="<?php echo vmText::_ ('COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT') ?>"  name="addtocart" href="#" class="addtocart-button btn btn-primary addtocart-button-disabled"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT') ?></span></span></a>
							<?php } ?>
						</div>
