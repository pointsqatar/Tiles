				...
				jQuery(document).ready(function(){
					jQuery('.socialsharing_product .social-sharing').on('click', function(){
						...
						if (type.length)
						{
							...
							{
								case 'twitter':
									window.open('https://twitter.com/intent/tweet?text=' + '<?php echo $this->product->product_name ?>' + ' ' + encodeURIComponent('<?php echo $og_url ?>'), 'sharertwt', 'toolbar=0,status=0,width=640,height=445');
									break;
								case 'facebook':
									window.open('http://www.facebook.com/sharer.php?u=' + encodeURIComponent('<?php echo $og_url ?>'), 'sharer', 'toolbar=0,status=0,width=660,height=445');
									break;
								case 'google-plus':
									window.open('https://plus.google.com/share?url=' + encodeURIComponent('<?php echo $og_url ?>'), 'sharer', 'toolbar=0,status=0,width=660,height=445');
									break;
								case 'pinterest':
									window.open('http://www.pinterest.com/pin/create/button/?media=' + '<?php echo $og_image ?>' + '&url=' + encodeURIComponent('<?php echo $og_url ?>'), 'sharerpinterest', 'toolbar=0,status=0,width=660,height=445');
									break;
							}
						}
					});
